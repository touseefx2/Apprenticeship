...
function   ChatBox  (props) {
 ...
 const {user,allUsers,room,setRoom,addRoom} = props.store;

 const allSup=allUsers
...
{allSup.length<=0&&(
<View>
<Text style={{fontSize:16,color:"#919191",alignSelf:"center",marginTop:10,marginBottom:10}}>No Any User Found</Text>
</View>)}
